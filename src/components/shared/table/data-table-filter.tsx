...
function deriveOptions<TData extends RowData>(
...
function getFilterableColumns<TData extends RowData, TValue>(
...
interface FilterContextValue {
  table: Table<AppTableFeatures, Record<string, unknown>>;
...
function DataTableFilter<TData extends RowData, TValue>({
  ...
  return (
    <FilterContext.Provider
      value={{
        table: table as Table<AppTableFeatures, Record<string, unknown>>,
        filterableColumns,
        columnFilters,
        inactiveColumns,
        handleSetFilter,
