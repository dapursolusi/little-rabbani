...
export interface FilterComponentProps {
  ...
  column: Column<TableFeatures, RowData, unknown>;
}
...
export interface CustomFilter<TData extends RowData = RowData> {
  component: ComponentType<FilterComponentProps>;
  filterFn: FilterFn<TableFeatures, TData>;
  title?: string;
}

export type TColumnFilter = RegistryFilter | CustomFilter<RowData>;
